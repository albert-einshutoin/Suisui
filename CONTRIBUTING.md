...
Suisui is developed with GitHub Flow, TDD, and a review-before-write safety model.
...
OpenCode is not part of the Suisui route. Before starting automation, run:
