...
Generated at: 2026-06-24T01:35:18Z
Source commit: 735a0f3

## Summary

- Phase14 completion: 250/250 checked, 0 remaining (`tasks/Phase14-QualityRegressionHardening.md`)
...
| --- | --- | --- |
| `docs/release/evidence/ui-screenshots.md` | present | 735a0f3 |
| `docs/release/evidence/mcp-inspector.md` | present | 7298e51 |
| `docs/release/evidence/accessibility-voiceover.md` | stale (passed; expected 735a0f3) | e488456 |
...
| Manual evidence | manual | VoiceOver: stale (passed; expected 735a0f3); Competitor: pending | `docs/release/evidence/accessibility-voiceover.md` | Manual findings must link back through docs/quality/manual-to-automated-regression.md. |
...
- [ ] Manual evidence status is VoiceOver=stale (passed; expected 735a0f3), Competitor=pending. Next: use `script/release_readiness_report.sh` for release evidence blockers and link any findings to regression coverage.
