...
Generated at: 2026-06-24T02:02:36Z
Source commit: 838fb03
...
| `docs/release/evidence/accessibility-voiceover.md` | stale (passed; expected 838fb03) | e488456 |
...
| Manual evidence | manual | VoiceOver: stale (passed; expected 838fb03); Competitor: pending | `docs/release/evidence/accessibility-voiceover.md` | Manual findings must link back through docs/quality/manual-to-automated-regression.md. |
...
- [ ] Manual evidence status is VoiceOver=stale (passed; expected 838fb03), Competitor=pending. Next: use `script/release_readiness_report.sh` for release evidence blockers and link any findings to regression coverage.
