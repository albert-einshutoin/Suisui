...
Generated at: 2026-06-23T20:27:07Z
Source commit: 4c3c7f3

## Summary

- Phase14 completion: 211/211 checked, 0 remaining (`tasks/Phase14-QualityRegressionHardening.md`)
...
| `docs/release/evidence/accessibility-voiceover.md` | stale (passed; expected 4c3c7f3) | e488456 |
...
| Manual evidence | manual | VoiceOver: stale (passed; expected 4c3c7f3); Competitor: pending | `docs/release/evidence/accessibility-voiceover.md` | Manual findings must link back through docs/quality/manual-to-automated-regression.md. |
...
- [ ] Manual evidence status is VoiceOver=stale (passed; expected 4c3c7f3), Competitor=pending. Next: use `script/release_readiness_report.sh` for release evidence blockers and link any findings to regression coverage.
