...
Generated at: 2026-06-23T08:01:47Z
Source commit: d472783
...
- Automated preflight evidence: `.tmp/automated-release-preflight-d472783.md`
...
| --- | --- | --- |
| `docs/release/evidence/ui-screenshots.md` | present | 7298e51 |
| `docs/release/evidence/mcp-inspector.md` | present | 7298e51 |
| `docs/release/evidence/accessibility-voiceover.md` | stale (passed; expected 7298e51) | e488456 |
...
| Manual evidence | manual | VoiceOver: stale (passed; expected 7298e51); Competitor: pending | `docs/release/evidence/accessibility-voiceover.md` | Manual findings must link back through docs/quality/manual-to-automated-regression.md. |
...
- [ ] Manual evidence status is VoiceOver=stale (passed; expected 7298e51), Competitor=pending. Next: use `script/release_readiness_report.sh` for release evidence blockers and link any findings to regression coverage.
...
- `SOLOPM_AUTOMATED_PREFLIGHT_EVIDENCE_FILE=.tmp/automated-release-preflight-d472783.md ./script/release_readiness_report.sh`
