...
Generated at: 2026-06-23T22:25:12Z
Source commit: 335e22b

## Summary

- Phase14 completion: 220/220 checked, 0 remaining (`tasks/Phase14-QualityRegressionHardening.md`)
...
| --- | --- | --- |
| `docs/release/evidence/ui-screenshots.md` | present | f1dffb2 |
| `docs/release/evidence/mcp-inspector.md` | present | 7298e51 |
| `docs/release/evidence/accessibility-voiceover.md` | stale (passed; expected 335e22b) | e488456 |
...
| Manual evidence | manual | VoiceOver: stale (passed; expected 335e22b); Competitor: pending | `docs/release/evidence/accessibility-voiceover.md` | Manual findings must link back through docs/quality/manual-to-automated-regression.md. |
...
- [ ] Manual evidence status is VoiceOver=stale (passed; expected 335e22b), Competitor=pending. Next: use `script/release_readiness_report.sh` for release evidence blockers and link any findings to regression coverage.
