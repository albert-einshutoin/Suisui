...
| --- | --- | --- |
| `docs/release/evidence/ui-screenshots.md` | present | ad1e616 |
| `docs/release/evidence/mcp-inspector.md` | present | 7298e51 |
| `docs/release/evidence/accessibility-voiceover.md` | stale (passed; expected ad1e616) | e488456 |
...
- [ ] Manual evidence status is VoiceOver=stale (passed; expected ad1e616), Competitor=pending. Next: use `script/release_readiness_report.sh` for release evidence blockers and link any findings to regression coverage.
