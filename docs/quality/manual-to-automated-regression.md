...
- Missing approval gates, source document IDs, matching redacted source previews, or draft risk classification belong in `SoloPMHarnessDocumentAutomationRunner`.
