...
| sidebar、toolbar、detail、inspector、window サイズ、表示モード | `./script/check_layout_stability_smoke.sh`、`./script/check_project_board_header_layout_smoke.sh`、または両方を含む `./scripts/ci.sh ui-runtime` | overlap、clipping、frame jump を許容せず、ADR 0009 の同期 mutation 契約を守る。 |
