...
| Project expected artifact links | Adopted | Keeps Notion-like flexible project evidence without adding arbitrary database schemas. | Local SQLite mutation tests and Project Overview source tests. |
