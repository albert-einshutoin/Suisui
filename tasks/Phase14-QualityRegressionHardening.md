...
- [ ] 主要CRUDのfocus pathを `docs/quality/accessibility-focus-paths.md` に記録する。
- [ ] `check_accessibility_preflight.sh --runtime` の対象画面をInbox/Today/Settingsへ広げる。
- [ ] UI component追加時のAX identifier命名規則を定義する。
