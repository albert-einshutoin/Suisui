...
- [x] Generated competitor hands-on evidence command verifies `.tmp/competitor-hands-on/hands-on-worksheet.md` is current, marked completed, filled, and free of pending/unchecked markers before validation or passed evidence.
