...
- [ ] VoiceOver label、focus order、button help、destructive confirmationを確認する。
  ...
  - [x] `script/check_accessibility_preflight.sh --runtime` はProject Board上のShow Archived、Add Project、Add Task、Save、Complete、Archive、DeleteのAX identifier/help signalsを `crudSignals=8/8` としてblocker化する。
