...
- [x] UI screenshot証跡は `Sources/SoloPMApp` / `Sources/SoloPMCore` / `Package.swift` の最新UI source commitを記録し、UI/runtime source変更後に古いスクリーンショットをrelease evidenceとして再利用しない。
