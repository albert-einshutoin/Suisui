...
| CN-006 | Verification-before-handoff gate | `SuisuiHarness`, release readiness scripts, generated work packet schema | Tests require focused verifier commands, expected artifacts, rollback note, and explicit "do not auto-merge/auto-push" policy before export | Every agent handoff packet includes how to prove success before PR/merge and keeps destructive or remote writes approval-gated. |
| CN-007 | Competitive launch messaging update | README, Public Alpha notes, release notes, product role docs | Source tests require Notion/Cursor comparison, local-first boundary, personal PM scope, and honest non-goals | Public Alpha messaging acknowledges the market move and explains why Suisui focuses on private individual project execution rather than team workspace coding automation. |
