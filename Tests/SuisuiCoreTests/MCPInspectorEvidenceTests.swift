...
final class MCPInspectorEvidenceTests: XCTestCase {
    ...
    func testReleaseReadinessAgreesWithGeneratedInspectorEvidenceSourceCommit() throws {
        ...
        XCTAssertTrue(releaseReadiness.contains("-u SUISUI_MCP_INSPECTOR_BIN"))
        XCTAssertTrue(releaseReadiness.contains("-u SUISUI_MCP_NPX_BIN"))
        XCTAssertTrue(releaseReadiness.contains(#"expected_mcp_source_commit="$(mcp_evidence_source_commit)""#))
