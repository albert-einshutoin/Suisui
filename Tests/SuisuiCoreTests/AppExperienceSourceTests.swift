...
final class AppExperienceSourceTests: XCTestCase {
    ...
    func testTodayDashboardUsesReferenceHierarchyAndStableAccessibilityIdentifiers() throws {
        ...
        XCTAssertTrue(header.contains("Suisui Today: %@. %@. %@ today, %@ scheduled"))
        XCTAssertTrue(header.contains("localizedTaskCount(header.taskCount)"))
        XCTAssertTrue(header.contains("localizedTaskCount(header.scheduledTaskCount)"))
        ...
        XCTAssertTrue(dashboard.contains("viewModel.startFocus(taskID: taskID)"))
        XCTAssertTrue(dashboard.contains("case .openReview:"))
        XCTAssertTrue(dashboard.contains(".accessibilityFocused($isReviewFocused)"))
        XCTAssertTrue(dashboard.contains("viewModel.prepareTodayScheduleDraft(prioritizing: taskID)"))
    ...
    func testTodayWorkflowUsesStableLayoutsForSizeFittingSensitiveScopes() throws {
        ...
        XCTAssertTrue(todayWorkflowScope.contains("availableWidth >= TodayDashboardLayoutMetrics.twoColumnMinimumWidth"))
