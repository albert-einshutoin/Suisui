...
final class AppExperienceSourceTests: XCTestCase {
    ...
    func testTodayDashboardUsesReferenceHierarchyAndStableAccessibilityIdentifiers() throws {
        ...
        XCTAssertTrue(dashboard.contains("openReview: openReview"))
        XCTAssertTrue(todayWorkflow.contains("openReview: openReview"))
        XCTAssertTrue(board.contains("openReview: { boardRouteBinding.wrappedValue = .primary(.review) }"))
