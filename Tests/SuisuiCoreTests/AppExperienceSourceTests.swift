...
final class AppExperienceSourceTests: XCTestCase {
    ...
    func testTodayDashboardUsesReferenceHierarchyAndStableAccessibilityIdentifiers() throws {
        ...
        XCTAssertTrue(dashboard.contains("let availableWidth = max(proxy.size.width, 1)"))
        ...
        XCTAssertTrue(dashboard.contains("resolvedPrefersContinuousRail(measuredWide:"))
        XCTAssertTrue(dashboard.contains("CockpitLayoutPolicy.presentsSplitRail(contentWidth: Double(availableWidth))"))
    ...
    func testTodayDashboardUsesReferenceVisualHierarchy() throws {
        ...
        XCTAssertTrue(dashboard.contains("frame(minWidth: 0, maxWidth: .infinity"))
        XCTAssertTrue(dashboard.contains("CGFloat(CockpitLayoutPolicy.standardContentWidth)"))
        ...
        XCTAssertFalse(dashboard.contains(".frame(width: availableWidth, alignment: .topLeading)"))
        XCTAssertTrue(dashboard.contains("resolvedPrefersContinuousRail(measuredWide:"))
    ...
    func testTodayWorkflowUsesStableLayoutsForSizeFittingSensitiveScopes() throws {
        ...
        XCTAssertTrue(todayWorkflowScope.contains("resolvedPrefersContinuousRail(measuredWide:"))
