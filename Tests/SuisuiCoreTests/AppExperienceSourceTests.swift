...
final class AppExperienceSourceTests: XCTestCase {
    ...
    func testProjectBoardHeaderLayoutRuntimeSmokeCoversNativeChromeMinimumWidthAndUtilities() throws {
        ...
        XCTAssertTrue(script.contains("click_first_ax_identifier \"sidebar-open-search\""))
        XCTAssertTrue(script.contains("wait_for_ax_identifier_present \"command-palette-input\""))
        XCTAssertTrue(script.contains("click_first_ax_identifier \"sidebar-action-voice-command\""))
        XCTAssertTrue(script.contains("wait_for_ax_identifier_present \"voice-command-quick-command-tab\""))
        XCTAssertTrue(script.contains("wait_for_ax_identifier_present \"settings-status-overview\""))
