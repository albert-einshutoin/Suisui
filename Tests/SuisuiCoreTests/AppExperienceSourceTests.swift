...
final class AppExperienceSourceTests: XCTestCase {
    ...
    func testProjectBoardHeaderLayoutRuntimeSmokeCoversNativeChromeMinimumWidthAndUtilities() throws {
        ...
        XCTAssertTrue(sidebarSource.contains("ui_evidence_ax_text_input.swift"))
        XCTAssertTrue(sidebarSource.contains("Native Toolbar Review Project"))
        XCTAssertTrue(sidebarSource.contains("wait_for_process_ax_identifier \"command-palette-input\" \"absent\""))
        XCTAssertTrue(sidebarSource.contains("press_ax_button \"command-palette-row-project-$header_layout_project_id\""))
        XCTAssertTrue(sidebarSource.contains("wait_for_process_ax_identifier \"voice-conversation-workspace\" \"absent\""))
