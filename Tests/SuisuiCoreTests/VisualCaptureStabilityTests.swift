...
final class VisualCaptureStabilityTests: XCTestCase {
    ...
    func testSystemEvidencePinsDarkAppAppearanceAndRejectsWrongRasterAppearance() throws {
        ...
        XCTAssertTrue(capture.contains("SUISUI_VISUAL_EVIDENCE_SYSTEM_APPEARANCE=dark"))
        ...
        XCTAssertTrue(app.contains("SUISUI_VISUAL_EVIDENCE_SYSTEM_APPEARANCE"))
        XCTAssertTrue(app.contains("NSAppearance(named: .darkAqua)"))
        XCTAssertTrue(app.contains("SuisuiAppearancePreference.environmentOverride == .system"))
    ...
    func testCaptureRequiresSeedMetadataAndConvergedConsecutiveRasters() throws {
        ...
        XCTAssertTrue(source.contains("in_progress_label=\"進行中\""))
        ...
        XCTAssertTrue(source.contains("SUISUI_UI_EVIDENCE_AX_REQUIRE_IDENTIFIER_SUBTREE=1"))
        XCTAssertTrue(source.contains("SUISUI_UI_EVIDENCE_AX_REQUIRE_EXACT_IDENTIFIER=1"))
        ...
        XCTAssertTrue(source.contains("inbox-voice-intake-detail=>Voice intake detail for $INBOX_VOICE_TITLE"))
        ...
        XCTAssertTrue(source.contains("ui_evidence_pointer_park.swift"))
    ...
    func testAXHelpersCompileAndExposeStrictCaptureIdentityModes() throws {
        ...
        XCTAssertTrue(marker.contains("SUISUI_UI_EVIDENCE_AX_REQUIRE_EXACT_IDENTIFIER"))
        ...
        XCTAssertTrue(frame.contains("SUISUI_UI_EVIDENCE_AX_IDENTITY_FINGERPRINT"))
