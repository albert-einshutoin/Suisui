...
final class VoiceDevelopmentPullRequestAutomationRequestBuilderTests: XCTestCase {
    ...
    func testReviewCommandMentioningMergeRemainsReviewGate() throws {
        ...
        let route = VoiceCommandRouter().route(transcript: """
        Review PR https://github.com/albert-einshutoin/suisui/pull/116 branch feature/suisui-7-merge-gate base feature/phase14-product-completion before merge
        """)
        let builder = VoiceDevelopmentPullRequestAutomationRequestBuilder(
            bookmarkResolver: StaticBookmarkResolver(url: workspace),
            requestIDProvider: { "voice-pr-review" }
    ...
    func testNegatedMergeCommandDoesNotQueueMergeAutomation() throws {
        ...
        Do not merge PR https://github.com/albert-einshutoin/suisui/pull/116 branch feature/suisui-7-merge-gate base feature/phase14-product-completion
        """)
        let japaneseRoute = VoiceCommandRouter().route(transcript: """
        PR https://github.com/albert-einshutoin/suisui/pull/116 ブランチ feature/suisui-7-merge-gate ベース feature/phase14-product-completion はマージしないで確認して
        """)
    ...
    func testRejectsUnsafeHeadBranchAndMatchingBaseBranch() throws {
        ...
        Review PR https://github.com/albert-einshutoin/suisui/pull/116 branch main base feature/phase14-product-completion
        """)
        let matchingBranchRoute = VoiceCommandRouter().route(transcript: """
        Review PR https://github.com/albert-einshutoin/suisui/pull/116 branch feature/suisui-7-merge-gate base feature/suisui-7-merge-gate
        """)
    ...
    func testRedactsSecretsAndLocalPathsFromReviewSummary() throws {
        ...
        let route = VoiceCommandRouter().route(transcript: """
        Review PR https://github.com/albert-einshutoin/suisui/pull/116 branch feature/suisui-7-merge-gate base feature/phase14-product-completion after reading /Users/alice/Secret Project/notes.md token=sk-summary-secret123
        """)
        let builder = VoiceDevelopmentPullRequestAutomationRequestBuilder(
            bookmarkResolver: StaticBookmarkResolver(url: workspace),
            requestIDProvider: { "voice-pr-review" }
    ...
    private func makeWorkspace() throws -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("SuisuiVoicePRBuilderTests-\(UUID().uuidString)", isDirectory: true)
