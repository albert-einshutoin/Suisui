...
final class WebAppMVPTests: XCTestCase {
    ...
    func testPackageManifestDeclaresWebProductTargetAndBuildGate() throws {
        ...
        let source = try String(contentsOfFile: "Sources/SuisuiWeb/SuisuiWebMVP.swift")
        let document = try String(contentsOfFile: "docs/sync/web-app-mvp.md")

        XCTAssertTrue(package.contains("name: \"SuisuiWeb\""))
        XCTAssertTrue(package.contains("targets: [\"SuisuiWeb\"]"))
        XCTAssertTrue(package.contains("path: \"Sources/SuisuiWeb\""))
