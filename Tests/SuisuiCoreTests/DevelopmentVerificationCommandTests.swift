...
final class DevelopmentVerificationCommandTests: XCTestCase {
    func testVerificationCommandSchemaAllowsReviewedBranchContext() throws {
        ...
        let action = PlanAction(
            ...
            arguments: [
                "projectId": .number(1),
                "taskId": .number(1),
                "branchName": .string("feature/suisui-1-1-runtime-smoke"),
    ...
    func testVerificationCommandChecksReviewedBranchBeforeRunningCommand() throws {
        ...
        let gitRunner = RecordingDevelopmentVerificationGitRunner(output: GitCommandOutput(
            standardOutput: "feature/suisui-1-1-runtime-smoke\n",
            standardError: "",
            exitCode: 0
        ))
        let tool = DevelopmentVerificationCommandTool(
        ...
        XCTAssertThrowsError(
            ...
            XCTAssertEqual(
                ...
                .executionFailed(
                    ...
                    "Repository branch mismatch before verification: expected feature/suisui-1-1-runtime-smoke, found main."
                )
            )
        }
    ...
    private func temporaryDirectory() -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("SuisuiDevelopmentVerificationCommandTests")
