...
final class ExecutionReceiptTests: XCTestCase {
                ...
                actions: [
                    PlanAction(
                        ...
                        arguments: [
                            ...
                            "detail": .string("Allowed /Volumes/Satechi/Developer/suisui/docs/plan.md disallowed /Volumes/Satechi/Developer/suisui/../Private/escape.md and /Users/alice/My Project/secrets.md")
                        ],
                        riskLevel: .write
                    )
                ],
    ...
    func testReviewExecutionReceiptLinksDevelopmentBranchEvidenceFromPRWorkflowOutput() throws {
        ...
        let privateWorkspacePath = "/Users/alice/private-work/suisui"
    ...
    func testDevelopmentVerificationAndCommitReceiptsKeepReviewedBranchEvidence() throws {
        let branchName = "feature/suisui-7-42-implement-oauth-callback"
    ...
    func testReviewExecutionReceiptRedactsRepositoryFileWriteContents() throws {
        ...
        let branchName = "feature/suisui-7-42-billing"
        var session = ReviewSession(
    ...
    func testDevelopmentPublishReceiptKeepsBranchAndPullRequestReferencesWithoutCommandLeakage() throws {
        let branchName = "feature/suisui-7-publish-gate"
        let baseBranch = "feature/phase14-product-completion"
        let pullRequestURL = "https://github.com/albert-einshutoin/suisui/pull/106"
    ...
    func testDevelopmentMergeGateReceiptKeepsPullRequestEvidenceWithoutRawCommands() throws {
        let branchName = "feature/suisui-7-merge-gate"
        let baseBranch = "feature/phase14-product-completion"
