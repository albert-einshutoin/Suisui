...
final class ReleasePipelineTests: XCTestCase {
    ...
    func testAutomatedReleasePreflightScriptRunsRealLocalGatesWithoutFakingManualEvidence() throws {
        ...
        XCTAssertTrue(script.contains("./script/prepare_voiceover_review_candidate.sh --skip-build"))
        ...
        let voiceOverCandidateRange = try XCTUnwrap(script.range(of: "./script/prepare_voiceover_review_candidate.sh --skip-build"))
