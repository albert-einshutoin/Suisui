...
final class ReleasePipelineTests: XCTestCase {
    ...
    func testAutomatedReleasePreflightScriptRunsRealLocalGatesWithoutFakingManualEvidence() throws {
        ...
        XCTAssertTrue(script.contains("Tracked source tree: $source_tree_state"))
        XCTAssertTrue(script.contains("source_tree_state=\"clean\""))
        XCTAssertTrue(script.contains("source_tree_state=\"dirty\""))
