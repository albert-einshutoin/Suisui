...
final class ReleasePipelineTests: XCTestCase {
    ...
    func testReleaseLaunchPerformanceSmokeMeasuresColdLaunchAndWorkflowSwitches() throws {
        ...
        XCTAssertTrue(script.contains("measure_destination \"destination-assistant-queue\" \"review-destination-assistant-queue\" \"Assistant Queue\" \"assistant-queue-workflow\""))
    ...
    func testReleaseReadinessReportAggregatesRuntimeMockScanTasksAndPreflight() throws {
        ...
        XCTAssertTrue(script.contains("(?i:(^|[^[:alnum:]_])demo([^[:alnum:]_]|$))"))
