...
final class ReleasePipelineTests: XCTestCase {
    ...
    func testRuntimeDevelopmentPRSmokeScriptRunsApprovedDirectoryFixtureFlow() throws {
        ...
        XCTAssertTrue(script.contains("verify_no_pull_request_followup()"))
        ...
        XCTAssertTrue(script.contains("No live GitHub PR, review gate, or merge is created by this smoke"))
        XCTAssertTrue(script.contains("fake branch push"))
        XCTAssertTrue(script.contains("payload_json NOT LIKE '%development.pr_workflow.create_pull_request%'"))
    ...
    func testRuntimeVoiceReviewSmokeScriptFailsClosedWithoutAPIKeyAndPersistsPlanningAudit() throws {
        ...
        XCTAssertGreaterThanOrEqual(script.components(separatedBy: "\"SELECT count(*) FROM projects;\"").count - 1, 4)
