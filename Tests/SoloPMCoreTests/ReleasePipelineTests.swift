...
final class ReleasePipelineTests: XCTestCase {
    ...
    func testAccessibilityPreflightChecksSourceAnchorsAndDocumentsRuntimeBoundary() throws {
        ...
        XCTAssertTrue(script.contains("project-board-add-project=>Add Project"))
        XCTAssertTrue(script.contains("project-header-add-task=>Add task"))
        XCTAssertTrue(script.contains("project-inspector-save=>Saves edits"))
        XCTAssertTrue(script.contains("project-inspector-delete=>Deletes the selected project"))
        ...
        XCTAssertTrue(checklist.contains("primary button label/help signals as `buttonA11ySignals=8/8`"))
    ...
    func testRuntimeAccessibleCRUDSmokeScriptLaunchesIsolatedAppAndVerifiesSQLiteMutations() throws {
        ...
        XCTAssertTrue(script.contains("pressDestructiveButtonUntilSQLiteValue \"deleted task\" \"task-inspector-delete\" \"task-inspector-delete-confirmation-confirm\" \"\" \"SELECT count(*) FROM tasks WHERE id=$created_task_id;\" \"0\" \"1\""))
        ...
        XCTAssertTrue(script.contains("pressDestructiveButtonUntilSQLiteValue \"deleted project\" \"project-inspector-delete\" \"project-inspector-delete-confirmation-confirm\" \"\" \"SELECT count(*) FROM projects WHERE id=$created_project_id;\" \"0\" \"1\""))
