...
final class ReleasePipelineTests: XCTestCase {
    ...
    func testRuntimeSettingsSaveSmokeScriptPersistsNonSecretSettingsToIsolatedUserDefaults() throws {
        ...
        XCTAssertTrue(script.contains("settings-google-calendar-readiness-row"))
        ...
        XCTAssertTrue(script.contains("settings-google-calendar-oauth-disconnect"))
        ...
        XCTAssertTrue(script.contains("waitForAXElementContaining \"settings-google-calendar-readiness-row\""))
        ...
        XCTAssertTrue(script.contains("waitForAXElementContaining \"settings-google-calendar-oauth-setup\""))
