...
final class ReleasePipelineTests: XCTestCase {
    ...
    func testReleaseReadinessReportWritesManualEvidenceBlockersToActionSummary() throws {
        ...
        XCTAssertTrue(actionSummary.contains("--delete-confirmation-note \"<VoiceOver observation proving inline inspector confirmation panel appears before deletion>\""))
