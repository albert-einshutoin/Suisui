...
final class ReleasePipelineTests: XCTestCase {
    ...
    func testManualUnblockerRunbookMapsRemainingReleaseBlockersToGeneratedCommands() throws {
        ...
        XCTAssertTrue(runbook.contains("Current automated evidence: `.tmp/automated-release-preflight-5875b4e.md`"))
        XCTAssertTrue(runbook.contains("Current release-candidate source commit: `17880b5`"))
        ...
        for path in [
            ...
            ".tmp/competitor-hands-on/competitor-benchmark-pending-17880b5.md",
        ...
        XCTAssertTrue(runbook.contains("SOLOPM_AUTOMATED_PREFLIGHT_EVIDENCE_FILE=.tmp/automated-release-preflight-5875b4e.md ./script/release_readiness_report.sh"))
