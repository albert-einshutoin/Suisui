...
final class ReleasePipelineTests: XCTestCase {
    ...
    func testRuntimeDevelopmentPRSmokeScriptRunsApprovedDirectoryFixtureFlow() throws {
        ...
        XCTAssertTrue(script.contains("verify_no_review_or_merge_followup()"))
        ...
        XCTAssertTrue(script.contains("No live GitHub PR creation, review gate, or merge is created by this smoke"))
