...
final class STTProviderTests: XCTestCase {
    ...
    func testProcessWhisperCppCommandRunnerDrainsAndCapsLargeStderr() async throws {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("solopm-whisper-runner-\(UUID().uuidString)", isDirectory: true)
    ...
    private func makeWhisperCppFixture(
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("solopm-whisper-fixture-\(UUID().uuidString)", isDirectory: true)
