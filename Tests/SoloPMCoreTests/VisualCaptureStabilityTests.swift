...
final class VisualCaptureStabilityTests: XCTestCase {
    func testCaptureRequiresSeedMetadataAndConvergedConsecutiveRasters() throws {
        ...
        XCTAssertTrue(source.contains("task-card-metadata-strip-$unscheduled_task_id=>$planned_label, $medium_label, $no_due_date_label"))
        ...
        XCTAssertTrue(source.contains("task-card-metadata-strip-$capture_task_id=>$planned_label, $high_label, $capture_due_date"))
