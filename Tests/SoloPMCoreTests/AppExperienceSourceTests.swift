...
final class AppExperienceSourceTests: XCTestCase {
    ...
    func testUIScreenshotEvidenceUsesIsolatedSeededProjectBoard() throws {
        ...
        XCTAssertTrue(script.contains("SOLOPM_VISUAL_EVIDENCE_SYSTEM_APPEARANCE=dark"))
        ...
        XCTAssertTrue(script.contains("schedule-mode-option-workload"))
        XCTAssertTrue(script.contains("SOLOPM_VISUAL_EVIDENCE_SCHEDULE_MODE=$SCHEDULE_MODE_OVERRIDE"))
        XCTAssertTrue(script.contains("schedule-workload-dashboard\" \"\" workload"))
