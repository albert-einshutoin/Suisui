...
final class AppExperienceSourceTests: XCTestCase {
    ...
    func testInboxWorkflowSurfacesVoiceCaptureMetadataWithoutReplacingVoiceCommand() throws {
        ...
        XCTAssertTrue(workflowSource.contains("Playback unavailable in this MVP, duration \\(capture.durationLabel), waveform preview placeholder"))
    ...
    func testVoiceDailyPlanningReviewBridgeUsesLocalProjectBoardReview() throws {
        ...
        XCTAssertTrue(appSource.contains("SoloPMVoiceDailyPlanningReviewBridge.storePendingRequest(request)"))
    ...
    func testScheduleWorkflowIsReachableAndApprovalFirst() throws {
        ...
        XCTAssertTrue(workflowSource.contains("viewModel.enqueueScheduleDraftCalendarApply()"))
