...
require_positive_integer TAKT_LOOP_MAX_AUTO_MERGE_FILES "$REQUESTED_MAX_AUTO_MERGE_FILES"
require_positive_integer TAKT_LOOP_MAX_AUTO_MERGE_LINES "$REQUESTED_MAX_AUTO_MERGE_LINES"
MAX_AUTO_MERGE_FILES=$((REQUESTED_MAX_AUTO_MERGE_FILES < HARD_MAX_AUTO_MERGE_FILES ? REQUESTED_MAX_AUTO_MERGE_FILES : HARD_MAX_AUTO_MERGE_FILES))
MAX_AUTO_MERGE_LINES=$((REQUESTED_MAX_AUTO_MERGE_LINES < HARD_MAX_AUTO_MERGE_LINES ? REQUESTED_MAX_AUTO_MERGE_LINES : HARD_MAX_AUTO_MERGE_LINES))
