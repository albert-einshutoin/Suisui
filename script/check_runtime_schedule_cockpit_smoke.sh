...
waitForAXElementContaining "schedule-search-focus"
pressButtonContaining "schedule-search-focus"
waitForAXElementContaining "schedule-week-time-axis-all-day-slot-$runtime_day_key" "AX Runtime Schedule Due"
...
waitForAXElementContaining "schedule-quick-draft-composer" "AX Runtime Schedule Unscheduled"
pressButtonContaining "schedule-quick-draft-save"
...
waitForAXElementContaining "schedule-week-block-" "AX Runtime Schedule Unscheduled"
pressButtonContaining "schedule-mode-option-agenda"
waitForAXElementContaining "schedule-agenda"
waitForAXElementContaining "schedule-agenda-block-$unscheduled_task_id" "AX Runtime Schedule Unscheduled"
...
printf "OK: runtime schedule cockpit smoke covered overview-to-day-to-agenda navigation, unscheduled add-to-draft, and approval-gated Calendar apply\n"
