...
failure_reproduction_command() {
  ...
  case "$blocker_message" in
    ...
    *"MCP compliance"*)
      ...
      ;;
    *"local voice runtime"*)
      printf 'SOLOPM_LOCAL_VOICE_EVIDENCE_FILE=docs/release/evidence/local-voice-runtime.md SOLOPM_STT_EXPECTED_TRANSCRIPT_CONTAINS="<expected words>" ./script/check_local_voice_runtime_smoke.sh'
      ;;
