...
write_voiceover_evidence_command() {
...

  {
    ...
    printf '%s\n' '  }'
    printf '%s\n' ''
    printf '%s\n' '  for required_label in "Reviewer" "Accessibility environment" "Runtime AX smoke" "Project navigation" "Project board detail" "Open task" "Inline Task Composer" "Status controls" "Task inspector" "Save Changes" "Task content execution" "Delete Task confirmation" "No keyboard trap" "No unlabeled primary CRUD controls"; do'
