...
write_voiceover_review_worksheet() {
...

  {
    ...
    printf '%s\n' '| `crudSignals=8/8` | Save Changes, Delete Task confirmation, No unlabeled primary CRUD controls | Confirm create, update, complete/archive/delete, and confirmation entry points are understandable. |'
    printf '%s\n' '| `buttonA11ySignals=8/8` | No unlabeled primary CRUD controls | Confirm primary Project Board buttons retain useful label or help text. |'
