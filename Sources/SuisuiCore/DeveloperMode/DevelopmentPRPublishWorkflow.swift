...
public struct ProcessGitHubCLICommandRunner: GitHubCLICommandRunner {
    ...
    private static let runtimeDevelopmentExpectedBaseKey = "SUISUI_RUNTIME_DEVELOPMENT_PR_EXPECTED_BASE"
    private static let runtimeDevelopmentPullRequestURLKey = "SUISUI_RUNTIME_DEVELOPMENT_PR_CREATE_URL"
    private static let runtimeDevelopmentPullRequestCreateLogKey = "SUISUI_RUNTIME_DEVELOPMENT_PR_CREATE_LOG"
    private static let runtimeDevelopmentPullRequestReviewLogKey = "SUISUI_RUNTIME_DEVELOPMENT_PR_REVIEW_LOG"
    private static let runtimeDevelopmentPullRequestMergeLogKey = "SUISUI_RUNTIME_DEVELOPMENT_PR_MERGE_LOG"
        ...
        do {
            ...
            return try withExtendedLifetime(scope) {
                ...
                let bodyFileURL = fileManager.temporaryDirectory
                    .appendingPathComponent("suisui-pr-body-\(UUID().uuidString).md")
