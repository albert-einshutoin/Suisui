...
public struct VisualEvidenceRuntimeContext: Equatable, Sendable {
    public static let referenceInstantEnvironmentKey = "SUISUI_VISUAL_EVIDENCE_REFERENCE_INSTANT"
    public static let timeZoneEnvironmentKey = "SUISUI_VISUAL_EVIDENCE_TIME_ZONE"
    public static let localeEnvironmentKey = "SUISUI_VISUAL_EVIDENCE_LOCALE_IDENTIFIER"
