        ...
        candidates = [
            ...
            RouteCandidate(
                ...
                signals: [
                    ...
                    .init(phrase: "daily review", weight: 2.3),
                    .init(phrase: "today review", weight: 2.3),
                    .init(phrase: "open today review", weight: 2.5),
                    .init(phrase: "what should i focus", weight: 2.0),
                    .init(phrase: "what should i do", weight: 1.8),
                    .init(phrase: "focus on today", weight: 1.8),
                    // These issue-acceptance phrases belong to planning review,
                    // while explicit count/progress wording still wins through
                    // the status.ask weights below.
                    .init(phrase: "overdue work", weight: 1.7),
                    .init(phrase: "overdue only", weight: 2.0),
                    .init(phrase: "tell me only the overdue", weight: 2.4),
                    .init(phrase: "late work", weight: 1.8),
                    .init(phrase: "only the overdue", weight: 2.2),
                    .init(phrase: "check in this evening", weight: 1.7),
                    ...
                    .init(phrase: "日次計画レビュー", weight: 2.4),
                    .init(phrase: "今日のレビュー", weight: 2.3),
                    .init(phrase: "今日のレビューを開", weight: 2.4),
                    .init(phrase: "今日やること", weight: 2.1),
                    .init(phrase: "今日", weight: 1.1),
                    .init(phrase: "今から", weight: 1.4),
                    .init(phrase: "遅れて", weight: 2.0),
                    .init(phrase: "できる順", weight: 1.6),
                    .init(phrase: "並べ", weight: 1.3),
                    .init(phrase: "夕方", weight: 1.6),
                    .init(phrase: "もう一回", weight: 1.2),
            ...
            RouteCandidate(
                ...
                signals: [
                    ...
                    .init(phrase: "予定をできる順", weight: 1.5),
            ...
            RouteCandidate(
                ...
                signals: [
                    ...
                    .init(phrase: "overdue tasks", weight: 1.4),
