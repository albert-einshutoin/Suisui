...
public struct ManagedAICostRateCardConfiguration: Equatable, Sendable {
    public static let providerIDEnvironmentKey = "SOLOPM_MANAGED_AI_PROVIDER_ID"
    public static let modelNameEnvironmentKey = "SOLOPM_MANAGED_AI_MODEL_NAME"
    public static let currencyCodeEnvironmentKey = "SOLOPM_MANAGED_AI_CURRENCY_CODE"
    public static let inputTokenCentsPerMillionEnvironmentKey = "SOLOPM_MANAGED_AI_INPUT_CENTS_PER_MILLION"
    public static let outputTokenCentsPerMillionEnvironmentKey = "SOLOPM_MANAGED_AI_OUTPUT_CENTS_PER_MILLION"
